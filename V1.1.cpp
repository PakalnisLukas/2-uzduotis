...
int main()
{
    ...
    {
        std::cout << "\nKKaip norite apskaiciuoti studentu galutini pazymi?\nSpauskite:"
    ...
    label: std::cin >> a;
        ...
        for (std::size_t i = 1000; i != 100000000; i *= 10)
        {
            ...
            std::vector<Studentas> Neigiami, Teigiami;
            ...
            while (IT != studentas.end())
            {
                if ((*IT).GP(Vidurkis) < 5 && (*IT).GP(Mediana) < 5)
                    ...
                    Teigiami.push_back(*IT);
                IT++;
            }

            std::ofstream IrasymasNeigiami;
            IrasymasNeigiami.open("Neigiami.txt", std::ios::app);
            Spausdinti(IrasymasNeigiami, Neigiami, IlgiausiasVardas, IlgiausiaPavarde);
            IrasymasNeigiami.close();

            std::ofstream IrasymasTeigiami;
            IrasymasTeigiami.open("Teigiami.txt", std::ios::app);
            Spausdinti(IrasymasTeigiami, Teigiami, IlgiausiasVardas, IlgiausiaPavarde);
