...
int main()
{
    ...
    int Entry;
    int t, p;
    vector <Studentas> Stud, Neigiami, Teigiami;
    Entry = Pasirinkimas();
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                if (a == 0)
                {
                    ...
                    for (int i = 1000; i < 10000000; i * 10)
                    {
                        ...
                        GeneravimasOutputFiles(Stud, Neigiami, Teigiami, t);
                        Spausdinimas(Neigiami, t, "Neigiami_" + std::to_string(a) + ".txt");
                        Spausdinimas(Teigiami, t, "Teigiami_" + std::to_string(a) + ".txt");
