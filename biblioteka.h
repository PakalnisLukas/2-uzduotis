...
const std::string Error = "Duomenys neatitinka reikalavimu. ";
...
public:
    ...
    int getDydis() const { return ND_.size(); }
...
void SpaudintiVidurki(std::string::size_type, std::string::size_type);
