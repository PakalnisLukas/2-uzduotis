...
bool Neigiami1(Studentas& Stud)
{
    return (Stud.getFinalVidurkis() > 5);
}

bool Neigiami2(Studentas& Stud)
{
    return (Stud.getFinalMediana() > 5);
}

void GeneravimasOutputFiles(vector <Studentas>& Stud, vector <Studentas>& Neigiami, vector <Studentas>& Teigiami, int t)
{
    ...
    if (t == 0)
    {
        ...
        std::remove_copy_if(Stud.begin(), Stud.end(), std::back_inserter(Neigiami), Neigiami1);
        std::copy_if(Stud.begin(), Stud.end(), std::back_inserter(Teigiami), Neigiami1);
    ...
    else
    {
        ...
        std::remove_copy_if(Stud.begin(), Stud.end(), std::back_inserter(Neigiami), Neigiami2);
        std::copy_if(Stud.begin(), Stud.end(), std::back_inserter(Teigiami), Neigiami2);
